...
# Global Analytics Serializers
# class GlobalAnalyticsGetSerializer(serializers.ModelSerializer):
#     class Meta:
...
class CalorieAnalyticsGetSerializer(serializers.ModelSerializer):
    LEVEL_CALORIE = [
...
class RestrictionTagAnalyticsGetSerializer(serializers.ModelSerializer):
...
class AllergiesTagAnalyticsGetSerializer(serializers.ModelSerializer):
...
class IngredientTagAnalyticsGetSerializer(serializers.ModelSerializer):
...
class TasteTagAnalyticsGetSerializer(serializers.ModelSerializer):
...
class CookStyleAnalyticsGetSerializer(serializers.ModelSerializer):
