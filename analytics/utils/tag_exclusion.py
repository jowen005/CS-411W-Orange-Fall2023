...
def driver():
    ...
    for tag_type, _, AnalyticsModel in TAG_TYPES:
        for item in menu_items:
            ...
            try:
                ...
                # overall_to_create.append(AnalyticsModel(
                #     menu_item=item, 
                #     exclusion_count=overall_exclusions[f'{item.id}'].count, 
                #     date_stamp=current_datestamp
                # ))
            ...
            for tag in tag_sets[tag_type]:
                ...
                try:
                    ...
                    # tag_records_to_create.append(AnalyticsModel(
                    #     menu_item=item, 
                    #     tag=tag, 
                    #     exclusion_count=tag_exclusions[tag_type][f'{item.id}'][f'{tag.id}'], 
                    #     date_stamp=current_datestamp
    ...
    #     AnalyticsModel.objects.bulk_update(tag_records_to_update)
    #     AnalyticsModel.objects.bulk_create(tag_records_to_create)
